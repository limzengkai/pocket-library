@extends('admin.admin_layout')
        ...
        <div class="container-fluid h-custom">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <h1 style="text-align: center" class="mt-3">TEACHER REGISTRATION</h1>
            <div class="col">
            ...
            @endif
                <div class="card">
                  <div class="card-body py-5 px-md-5">
                    <form action="{{route('teacher.register.create')}}" method="post">
                      @csrf
                      <!-- Name input -->                  
                      ...
                      <div class="row">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="password" name="password_comfirmation" minlength="8" class="form-control" />
                        </div>
                        </div>
                      </div>

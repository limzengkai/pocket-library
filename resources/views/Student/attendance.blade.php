...
@endsection
        ...
        @section('content')
                ...
                <div class="container-fluid">
                    ...
                    <h3 class="text-primary mb-4">Attendance</h3>
                            ...
                            <div class="card-body ">
                                <div class="table-responsive table mt-2" id="dataTable" role="grid"
                                    ...
                                    <div class="container row py-5 m-auto">
                                        <form method="POST" action="{{route('student.attendance.search')}}" class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search">
                                            @csrf
                                            <div class="container">
                                                <div class="row">
                                                    <div class="container-fluid">
                                        ...
                                        <div class="d-flex flex-row bd-highlight justify-content-center">
                                            <div class="mt-2 mb-2 w-25">
                                                <a href="{{route('student.qrcode')}}">
                                                    <button class="btn bg-danger w-100"> <span class="text-white">Get Qr Code</span> </button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>

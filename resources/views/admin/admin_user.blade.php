                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body p-5">
                            <h2 class="text-primary fw-bold text-center">Student Account Management</h2>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $stu->password }}</td>
                                            <td>
                                                <a class="btn btn-info" href="{{route('student.edit',$stu->id)}}">
                                                    <i class="fas fa-edit" aria-hidden="true"></i></button>
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-info" href="{{route('student.show',$stu->id)}}">

@extends('admin.admin_layout')
        ...
        @section('content')
                <div class="container-fluid">
                    ...
                    <div>
                        <a href="{{route('teacher.index')}}" style="text-decoration: none"><i class="fa fa-arrow-left"
                                ...
                                <form action="{{ route('teacher.update', $teacher->id) }}" method="POST">
                                    ...
                                    <div class="row m-3">
                                        ...
                                        {{-- <div class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <input type="text" name="name" value="{{ $teacher-> }}" class="form-control" placeholder="Name">
                                        </div> --}}
                                    </div>
                                </form>

                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body p-5">
                            <h2 class="text-primary fw-bold text-center">Admin Account Management</h2>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info" href="{{route('admin.edit',$admins->id)}}">
                                                    <i class="fas fa-edit" aria-hidden="true"></i></button>
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-info" href="{{route('admin.show',$admins->id)}}">
